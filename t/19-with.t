...
sub search : Tests {
    ...
    is $DBIx::MoCo::DataBase::SQL_COUNT, 1;

    Blog::Entry->icache_expiration(1000);
    Blog::Entry->has_a(
        user => 'Blog::User',
        { key => 'user_id' }
    );
    ...
    is $DBIx::MoCo::DataBase::SQL_COUNT, 0;

    Blog::Entry->icache_expiration(0);
    Blog::Entry->has_a(
        user => 'Blog::User',
        { key => 'user_id' }
    );
